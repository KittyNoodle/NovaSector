...
/obj/item/gun/magic/hardlight_spear/worn_overlays(mutable_appearance/standing, isinhands)
	...
	switch(spears_left)
		if(0)
			return
		if(1)
			back_spear_overlay = mutable_appearance('code/modules/archonic/icons/hardlightspear.dmi', "spear1", MOB_SHIELD_LAYER)
		if(2)
			back_spear_overlay = mutable_appearance('code/modules/archonic/icons/hardlightspear.dmi', "spear2", MOB_SHIELD_LAYER)
		if(3)
			back_spear_overlay = mutable_appearance('code/modules/archonic/icons/hardlightspear.dmi', "spear3", MOB_SHIELD_LAYER)
		if(4)
			back_spear_overlay = mutable_appearance('code/modules/archonic/icons/hardlightspear.dmi', "spear4", MOB_SHIELD_LAYER)
		if(5)
			back_spear_overlay = mutable_appearance('code/modules/archonic/icons/hardlightspear.dmi', "spear5", MOB_SHIELD_LAYER)
		if(6)
			back_spear_overlay = mutable_appearance('code/modules/archonic/icons/hardlightspear.dmi', "spear6", MOB_SHIELD_LAYER)
...
/obj/projectile/bullet/hardlight_spear
	...
	embed_type = /datum/embed_data/bullet/spear
